...
export function CompoundIcon({ size = 21, className }: { size?: `${number}` | number; className?: string }) {
    return (
        <Svg width={size} height={size} viewBox="0 0 28 28" fill="none">
            <Path
                d="M23.6662 0.75H3.75C2.09315 0.75 0.75 2.09314 0.75 3.75V23.6662C0.75 25.3231 2.09314 26.6662 3.75 26.6662H23.6662C25.3231 26.6662 26.6662 25.3231 26.6662 23.6662V3.75C26.6662 2.09315 25.3231 0.75 23.6662 0.75Z"
                stroke="black"
                strokeWidth="2.5"
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <Path
                d="M8.72442 26.6663V17.6953H4.7373"
                stroke="black"
                strokeWidth="2.5"
                strokeMiterlimit={10}
                strokeLinecap="round"
