        ...
        <GridContext.Provider value={contextValue}>
            <View
                ...
                onLayout={(event) => {
                    ...
                    const gridWidth =
                        Math.floor(event.nativeEvent.layout.width) - paddingLeftToSubtract - paddingRightToSubtract - borderWidthToSubtract;
...
const GridItem = forwardRef<React.ComponentRef<typeof View>, IGridItemProps>(function GridItem({ className, _extra, ...props }, ref) {
    ...
    }, [calculatedWidth, responsiveColSpan, numColumns, columnGap, gap, flexDirection, itemsPerRow, props?.index]);
    return (
        <View
            ref={ref}
