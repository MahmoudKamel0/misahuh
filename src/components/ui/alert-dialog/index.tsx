...
const AlertDialog = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog>, IAlertDialogProps>(function AlertDialog(
...
const AlertDialogContent = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Content>, IAlertDialogContentProps>(
...
const AlertDialogHeader = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Header>, IAlertDialogHeaderProps>(
...
const AlertDialogFooter = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Footer>, IAlertDialogFooterProps>(
...
const AlertDialogBody = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Body>, IAlertDialogBodyProps>(
...
const AlertDialogBackdrop = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Backdrop>, IAlertDialogBackdropProps>(
